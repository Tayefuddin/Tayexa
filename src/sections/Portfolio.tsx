...
function ProjectCard({ project, delay }: ProjectCardProps) {
  ...
  return (
    <article
      ...
      className={`card-interactive card-spotlight group reveal flex flex-col overflow-hidden rounded-2xl border border-slate bg-navy ${
        ...
        {FILTERS.map((filter) => {
          ...
          return (
            <button
              ...
              className={`rounded-full border px-5 py-2 text-sm font-semibold transition-all duration-300 active:scale-95 ${
                isActive
